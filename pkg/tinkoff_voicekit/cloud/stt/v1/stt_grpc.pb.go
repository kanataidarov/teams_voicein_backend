...
const (
	SpeechToText_Recognize_FullMethodName               = "/tinkoff.cloud.stt.v1.SpeechToText/Recognize"
	SpeechToText_StreamingRecognize_FullMethodName      = "/tinkoff.cloud.stt.v1.SpeechToText/StreamingRecognize"
	SpeechToText_LongRunningRecognize_FullMethodName    = "/tinkoff.cloud.stt.v1.SpeechToText/LongRunningRecognize"
	SpeechToText_StreamingUnaryRecognize_FullMethodName = "/tinkoff.cloud.stt.v1.SpeechToText/StreamingUnaryRecognize"
)
...
func (c *speechToTextClient) StreamingRecognize(ctx context.Context, opts ...grpc.CallOption) (SpeechToText_StreamingRecognizeClient, error) {
	stream, err := c.cc.NewStream(ctx, &SpeechToText_ServiceDesc.Streams[0], SpeechToText_StreamingRecognize_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *speechToTextClient) LongRunningRecognize(ctx context.Context, in *LongRunningRecognizeRequest, opts ...grpc.CallOption) (*v1.Operation, error) {
	...
	err := c.cc.Invoke(ctx, SpeechToText_LongRunningRecognize_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *speechToTextClient) StreamingUnaryRecognize(ctx context.Context, opts ...grpc.CallOption) (SpeechToText_StreamingUnaryRecognizeClient, error) {
	stream, err := c.cc.NewStream(ctx, &SpeechToText_ServiceDesc.Streams[1], SpeechToText_StreamingUnaryRecognize_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _SpeechToText_LongRunningRecognize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SpeechToText_LongRunningRecognize_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
