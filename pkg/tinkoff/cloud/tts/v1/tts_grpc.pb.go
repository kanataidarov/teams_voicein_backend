...
const (
	TextToSpeech_ListVoices_FullMethodName          = "/tinkoff.cloud.tts.v1.TextToSpeech/ListVoices"
	TextToSpeech_Synthesize_FullMethodName          = "/tinkoff.cloud.tts.v1.TextToSpeech/Synthesize"
	TextToSpeech_StreamingSynthesize_FullMethodName = "/tinkoff.cloud.tts.v1.TextToSpeech/StreamingSynthesize"
)
...
func (c *textToSpeechClient) Synthesize(ctx context.Context, in *SynthesizeSpeechRequest, opts ...grpc.CallOption) (*SynthesizeSpeechResponse, error) {
	...
	err := c.cc.Invoke(ctx, TextToSpeech_Synthesize_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TextToSpeech_Synthesize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TextToSpeech_Synthesize_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
