...
const (
	Operations_GetOperation_FullMethodName    = "/tinkoff.cloud.longrunning.v1.Operations/GetOperation"
	Operations_WaitOperation_FullMethodName   = "/tinkoff.cloud.longrunning.v1.Operations/WaitOperation"
	Operations_ListOperations_FullMethodName  = "/tinkoff.cloud.longrunning.v1.Operations/ListOperations"
	Operations_WatchOperations_FullMethodName = "/tinkoff.cloud.longrunning.v1.Operations/WatchOperations"
	Operations_DeleteOperation_FullMethodName = "/tinkoff.cloud.longrunning.v1.Operations/DeleteOperation"
	Operations_CancelOperation_FullMethodName = "/tinkoff.cloud.longrunning.v1.Operations/CancelOperation"
)
...
func (c *operationsClient) WatchOperations(ctx context.Context, in *WatchOperationsRequest, opts ...grpc.CallOption) (Operations_WatchOperationsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Operations_ServiceDesc.Streams[0], Operations_WatchOperations_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
